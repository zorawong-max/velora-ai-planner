      ...
      <Card>
        <CardContent className="flex flex-col items-center py-12 text-center">
          ...
          <p className="text-muted-foreground mt-2 max-w-sm text-sm">
            Complete the planning wizard to generate your infrastructure blueprint.
          </p>
          <Button
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-medium">Blueprint ready for expert review</p>
            </div>
            <p className="text-muted-foreground mt-1.5 text-sm">
              Send this blueprint to the VELORA team for expert review.
            </p>
          </div>
          <Button
      ...
      <p className="text-muted-foreground text-xs">
        Generated by VELORA Blueprint™ from your planning wizard answers.
      </p>
    </div>
  );
}
